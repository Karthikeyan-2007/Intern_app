...
import 'package:school_app/Student/Testscreen.dart';

class StudentAssessmentsDashboard extends StatefulWidget {
  const StudentAssessmentsDashboard({super.key});

  @override
  State<StudentAssessmentsDashboard> createState() =>
      _StudentAssessmentsDashboardState();
}

class _StudentAssessmentsDashboardState
    extends State<StudentAssessmentsDashboard> {
  ...
  Widget _buildSubjectSection(String subject, List<Map<String, dynamic>> items) {
    return Column(
      ...
      children: [
        ...
        ...items.map((item) => _buildAssessmentCard(item)).toList(),
    ...
    return GestureDetector(
      onTap: () {
        Navigator.push(
          context,
          MaterialPageRoute(
            builder: (context) => StudentAssessmentPage(test: item),
          ),
        );
      },
      child: Container(
                      ...
                      child: ElevatedButton(
                        style: ElevatedButton.styleFrom(
                          backgroundColor: isCompleted
                              ...
                              : _getSubjectColor(item['subject']),
                          foregroundColor: isCompleted
                              ? const Color(0xFF6B7599)
                              : Colors.white,
                        ...
                        onPressed: isCompleted
                            ...
                            : () {
                                Navigator.push(
                                  ...
                                  MaterialPageRoute(
                                    builder: (context) =>
                                        StudentAssessmentPage(test: item),
                                  ),
                                );
                              },
                        child: Row(
                          ...
                          children: [
                            ...
                            const SizedBox(width: 8),
                            Text(
                              isCompleted ? 'View Result' : 'Start Test',
                              style: const TextStyle(
                                fontWeight: FontWeight.w600,
                                fontSize: 15,
                              ),
